                        ...
                        <div class="col-lg-8">
                            ...
                            <!-- insert kriteria -->
                                ...
                                if (isset($_POST['submit'])) {
                                    ...
                                    //sql insert to siswa
                                    $sql = "INSERT INTO kriteria (nama_kriteria,bobot,keterangan )VALUES ('$kriteria','$bobot','$keterangan')";
                                        ...
                                        <table class="table table-striped table-bordered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="aksi/hapuskriteria.php?name=<?=$barisbobot['id_kriteria'];?>">hapus</a></td>
